...
warningOperation = RotatingFileHandler(path + 'ExWarning.log', maxBytes=5 * 1024 * 1024, backupCount=5)
...
criticalOperation = RotatingFileHandler(path + 'ExCritical.log', maxBytes=5 * 1024 * 1024, backupCount=5)
