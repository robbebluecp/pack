...
warningOperation = RotatingFileHandler(path + 'Z_ExWarning.log', maxBytes=5 * 1024 * 1024, backupCount=1)
...
criticalOperation = RotatingFileHandler(path + 'Z_ExCritical.log', maxBytes=5 * 1024 * 1024, backupCount=2)
